...
namespace UnrealUtilities
{
    ...
    /// copy-entry lists.
    /// </summary>
    public static class MaterializationSpecs
    {
        /// <summary>
        ...
        /// <summary>
        /// Reads plugin names directly from the project Plugins tree for materialization selection.
        /// </summary>
        ...
        /// <summary>
        /// Creates the explicit plugin subset directly from its directory and required descriptor path.
        /// </summary>
