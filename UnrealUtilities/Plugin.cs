...
namespace UnrealUtilities
{
    ...
    public class Plugin : IEngineInstanceProvider
    {
        ...
        /// <summary>Gets the authored engine identity from plugin or project metadata without installation lookup.</summary>
        public string EngineInstanceName => PluginDescriptor.EngineVersion?.MajorMinorString ?? HostProject.EngineInstanceName;
        ...
        /// <summary>Deletes the plugin directory and its contents.</summary>
