...
namespace UnrealUtilities
{
    ...
    internal static class PluginDeploymentFlattening
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            IReadOnlyList<MergeRule> mergeRules = ParseMergeRules(mergePluginsText);
            ...
            PluginFlattener.Flatten(stagingPlugin.UPluginPath, mergePlugins, packageInputPluginPath,
